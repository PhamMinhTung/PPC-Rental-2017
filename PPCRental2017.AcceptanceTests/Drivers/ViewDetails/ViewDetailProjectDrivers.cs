...
namespace PPCRental2017.AcceptanceTests.Driver.ViewDetails
{
    public class ViewDetailsDriver
    {
        ...
        public void OpenPropertyDetails(string PropertyName)
        {
            ...
            using (var controller = new ViewDetailProjectController())
            {
                _result = controller.ViewDetailProject(_Id);
            }
        }
    }
}
